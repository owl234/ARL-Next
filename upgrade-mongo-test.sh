...
MONGO_PASS="admin"
AUTH_DB="admin"
CONTAINER_NAME="arl-mongodb-test"
...
# 替换为 7.0 官方公有镜像
sed -i.bak 's|image: crpi-laul1izptqrf0tkf.cn-beijing.personal.cr.aliyuncs.com/owl234-arl-prod-test/mongo:4.0.27|image: mongo:7.0|g' $COMPOSE_FILE
# 替换数据卷，保障旧卷无损
